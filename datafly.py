...
class _Table:
    ...
    def anonymize(self, qi_names: list, k: int, output_path: str, v=True):
        ...
        while True:
            ...
            if count > k:
                ...
                for qi_sequence, data in qi_frequency.copy().items():
                    if data[0] < k:
                        qi_frequency.pop(qi_sequence)
    ...
    def _add_dgh(self, dgh_path: str, attribute: str):
        ...
        """
        Adds a Domain Generalization Hierarchy to this tablle DGH collection, from its file.
...
print(f"Done in {end:.3f} seconds")
